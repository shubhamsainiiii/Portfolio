...
const Hero = () => {
    return (
        <section id="home"
            className="flex flex-col md:flex-row items-center justify-around px-6 py-12 mt-32 md:py-24"
        >

            {/* Profile Image (Coming from Left) */}
            <motion.div
            ...
            {/* Profile Text (Coming from Right) */}
            <motion.div
                initial={{ x: 100, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
                transition={{ duration: 2 }}
            ...
            >
                ...
                <p className="text-justify text-[#001524] font-semibold mt-4">
                    Welcome to my portfolio website! I'm a passionate and aspiring web developer with a strong desire to
                    create innovative solutions and push the boundaries of technology.
                </p>

                {/* Buttons */}
                <div className="flex flex-col sm:flex-row justify-center md:justify-start mt-6 space-y-3 sm:space-y-0 sm:space-x-4">
                    <a href="Shubham_Resume.pdf" className="bg-teal-600 font-semibold text-[15px] text-white px-6 py-2 rounded-md hover:bg-teal-700 transition duration-300">
                        Download CV
                    </a>
