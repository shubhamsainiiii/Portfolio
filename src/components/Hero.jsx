    ...
    return (
        <section id="home" className="flex flex-col md:flex-row items-center justify-around px-6 py-12 mt-32 md:py-24">
            ...
            <motion.div
                ...
                viewport={{ once: false }}
                className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-5 border-[#001524]">
                <img
                    src={shubham_photo}
                    alt="Profile"
            ...
            >
                ...
                <div className="flex justify-center md:justify-start mt-6 space-x-4">
                    ...
                    <a href="https://wa.me/7691888950" target="_blank" rel="noopener noreferrer" className="text-gray-700 text-2xl hover:scale-110 transition duration-400">
