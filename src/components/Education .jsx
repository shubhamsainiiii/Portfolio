...
const Education = () => {
    return (
        <section id="education" className="py-16 flex justify-center mt-40">
            <div className="w-[95vw] max-w-2xl bg-white shadow-gray-900 shadow-sm rounded-lg px-8 py-4">
                {/* Education Title */}
                <motion.div
                ...
                >
                    ...
                    <div className="relative ">
                        <div className="absolute -left-8 top-1.5 w-4 h-4 bg-[#001524] rounded-full"></div>
                        ...
                        <p className="text-[#274c77] flex items-center">
                            <FaCalendar className="mr-2" /><span className="font-semibold"> 2015-2016</span>
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <h4 className="text-gray-600 font-semibold">Board Of Secondary Education Rajasthan</h4>
                        <p className="text-[#274c77] flex items-center">
                            <FaCalendar className="mr-2" /><span className="font-semibold"> 2017-2018</span>
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <p className="text-[#274c77] flex items-center">
                            <FaCalendar className="mr-2" /><span className="font-semibold"> 2019-2022</span>
                        </p>
                    </div>
                    <div className="relative">
                        <div className="absolute -left-8 top-1.5 w-4 h-4 bg-[#001524] rounded-full"></div>
                        ...
                        <p className="text-[#274c77] flex items-center">
                            <FaCalendar className="mr-2" /><span className="font-semibold"> 2024-Present</span>
                        </p>
                    </div>
                    <div className="relative">
                        <div className="absolute -left-8 top-1.5 w-4 h-4 bg-[#001524] rounded-full"></div>
                        ...
                        <p className="text-[#274c77] flex items-center">
                            <FaCalendar className="mr-2" /><span className="font-semibold">2024-2025</span>
                        </p>
                    </div>
                </motion.div>
            </div>
