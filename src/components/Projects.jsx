...
// import spocitsolutions from "../assets/images/spocitsolutions.png";
...
//     },
//     {
//         title: "SPOC IT Solutions",
//         description:
//             "A professional IT services website built to showcase software development, IT consulting, and digital solutions. The platform highlights company services, expertise, and client-focused solutions with a modern and responsive interface.",
//         image: spocitsolutions, // apni image variable yaha import kar lena
//         tech: ["React", "TailwindCSS", "Framer Motion"],
//         link: "https://spocitsolutions.com/",
//         code: "https://spocitsolutions.com/",
//     },
//     {
                            ...
                            <div className="p-6 flex flex-col flex-1">
                                ...
                                <div className="mt-auto">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className={`flex items-center justify-center w-full py-2 rounded-lg font-semibold transition-all duration-500 ${project.link
                                            ? "bg-[#1055C9] text-white hover:bg-blue-500"
                                            : "bg-gray-300 text-gray-500 cursor-not-allowed"
                                            }`}
                                    >
